...
AUDIO.VISUALIZER = (function () {
    ...
    function Visualizer (cfg) {
        ...
        this.font = cfg.font || ['18px', 'Raleway'];
        this.gradient = cfg.gradient || null;
    }
    ...
    Visualizer.prototype.setCanvasStyles = function () {
        this.gradient = this.canvasCtx.createLinearGradient(0, 0.9, 1, 300);
    ...
    Visualizer.prototype.renderLounge = function () {
        ...
        for (var i = 0; i < barNum; i++) {
            ...
            var x = 0;
            //Kedalaman Bar
            var y = radius - (amplitude / 30 - this.barHeight);
            var w = this.barWidth;
            //Tinggi Bar
            var h = amplitude / 2 + this.barHeight;
